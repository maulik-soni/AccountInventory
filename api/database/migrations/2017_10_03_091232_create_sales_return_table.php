...
class CreateSalesReturnTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales_return', function (Blueprint $table) {
            ...
            $table->float('purchase_amount_INR')->nullable();
            $table->float('purchase_amount_dolar')->nullable();
            $table->float('sales_amount_INR')->nullable();
            $table->float('sales_amount_dolar')->nullable();
            $table->float('diff_amount_INR')->nullable();
            $table->float('diff_amount_dolar')->nullable();
